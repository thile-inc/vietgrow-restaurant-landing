...
const copy = {
  ...
  "hero": {
    ...
    "title": "+50% More Revenue for F&B",
    "body": "A done-for-you ad funnel built to increase restaurant revenue. $119/month.",
  ...
  "hero": {
    ...
    "title": "+50% doanh thu cho F&B",
    "body": "Ad funnel done-for-you được xây để tăng doanh thu nhà hàng. $119/tháng.",
